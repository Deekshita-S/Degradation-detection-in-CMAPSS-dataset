...
2. **Thresholding**: A threshold is set on the reconstruction error, as the 95th percentile of the healthy data(training data), to detect the onset of degradation. The healthy timestamp is chosen based on literature.
...
- Transformer Architecture: Alamr, A.; Artoli, A. Unsupervised Transformer-Based Anomaly Detection in ECG Signals. Algorithms 2023, 16, 152. https://doi.org/10.3390/a16030152

- Jakubowski, J.; Stanisz, P.; Bobek, S.; Nalepa, G.J. Anomaly Detection in Asset Degradation Process Using Variational Autoencoder and Explanations. Sensors 2022, 22, 291. https://doi.org/10.3390/s22010291