...
* CMAPSS Dataset: [https://ti.arc.nasa.gov/tech/dash/groups/pcoe/prognostic-data-repository/](https://ti.arc.nasa.gov/tech/dash/groups/pcoe/prognostic-data-repository/)
...
Let me know if you'd like this exported as a `.md` or `.txt` file.
